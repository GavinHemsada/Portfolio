...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-black text-white pt-24 pb-12 px-10 border-t border-gray-900 overflow-hidden">
      ...
      {/* Big Brand Mark - Responsive */}
      <div className="w-full flex justify-center items-center py-6 sm:py-8 md:py-10 lg:py-16 select-none overflow-hidden relative">
        <style
        ...
        />
        <span
          className="block w-full text-center text-[10vw] xs:text-[12vw] sm:text-[8vw] md:text-[7vw] lg:text-[120px] xl:text-[200px] font-black leading-[1] tracking-tighter whitespace-nowrap text-transparent bg-clip-text bg-[linear-gradient(110deg,#ffffff,45%,#F3FE00,55%,#ffffff)] bg-[length:200%_100%] animate-shine"
          style={{
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-1 pt-8 border-t border-gray-900 flex flex-col md:flex-row justify-between items-center text-xs font-bold tracking-widest uppercase text-gray-600">
          ...
          <div className="flex space-x-8 mt-6 md:mt-0">
            <a href="#" className="hover:text-[#F3FE00] transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="hover:text-[#F3FE00] transition-colors">
              Terms of Service
